...
public class Server implements Runnable {
    ...
    protected static final int KILL_TIMEOUT = 70000;
     ...
     * given socket. */
    public Server( Board b, boolean createGUI, boolean qt, ServerSocket ss, int to ) {
            ...
            for( int i = 0; i < players.length; i++ ) {
                if( players[i].getPlayerID() == player_id ) {
                    ...
                    if(board.getTurnsPlayed() == 0){
                        resetTimer(FIRST_MOVE_TIMEOUT, i);
                    }else{
                        resetTimer(timeout, i);
                    }
    ...
    private void resetTimer(int timeout, int player_id) {
        cancelTimeout();
        ...
        timer.schedule( killTimeoutTask, KILL_TIMEOUT );
    }
